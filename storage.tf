...
resource "azurerm_storage_account" "storage_account" {
    ...
    name                     = "storage${var.project}${var.environment}177" //No permite caracteres especiales
...
// Administra un contenedor dentro de una cuenta de almacenamiento de Azure
...
// Administra una cola dentro de una cuenta de almacenamiento de Azure
